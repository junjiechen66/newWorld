...
| status | String | 否 | TODO | 状态: TODO/IN_PROGRESS/DONE/ARCHIVED |
...
**支持的状态值**: TODO, IN_PROGRESS, DONE, ARCHIVED
...
```javascript
// 获取任务列表
getTaskList({ status: 'TODO', page: 1, pageSize: 50 })
...
// 更新任务状态
updateTaskStatus(123, 'IN_PROGRESS')
